...
namespace MediaFixer.Core.IO
{
	...
	public class DirectoryUtility : IDirectoryUtility
	{
		...
		public void Rename(DirectoryInfo di, String name)
		{
			if (di == null)
		...
		/// <param name="name">The name.</param>
		public void Rename(String location, String name)
		{
			var di = GetDirectoryInfo(location);
			Rename(di, name);
		}
